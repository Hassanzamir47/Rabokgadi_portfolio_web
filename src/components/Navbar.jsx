    ...
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50 bg-[#54ad62] py-4">
          ...
          <div className="px-6 pt-6 lg:max-w-2xl lg:pl-8 lg:pr-0">
            ...
            >
              <a href="/" className="-m-1.5 p-1.5">
                <span className="sr-only">RABOKGADI</span>
                <img alt="RABOKGADI" className="w-16" src="/images/1.png" />
              </a>
              <button
                type="button"
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-[#54ad62] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="/" className="-m-1.5 p-1.5">
                <span className="sr-only">RABOKGADI</span>
                <img alt="RABOKGADI" className="w-8" src="/images/1.png" />
              </a>
              <button
                type="button"
